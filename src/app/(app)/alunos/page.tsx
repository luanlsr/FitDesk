...
export default function AlunosPage() {
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 animate-fade-up">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-[#16161A] border border-[#222228] p-4 rounded-2xl">
        <div className="relative flex-1 w-full max-w-md">
          ...
          <input 
            ...
            className="w-full bg-[#0A0A0B] border border-[#222228] rounded-xl pl-10 pr-4 py-2 text-sm text-[#F5F5F0] focus:border-[#FF5C00] focus:ring-1 focus:ring-[#FF5C00]/20 transition-all outline-none"
          />
        </div>
        <div className="flex items-center gap-2 w-full md:w-auto">
          <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-[#0A0A0B] border border-[#222228] rounded-xl text-[0.8rem] text-[#7A7A85] hover:text-[#F5F5F0] hover:border-[#7A7A85] transition-all">
      ...
      {/* List Table */}
      <div className="bg-[#16161A] border border-[#222228] rounded-2xl overflow-hidden shadow-xl overflow-x-auto">
        <table className="w-full text-left min-w-[800px]">
          <thead>
            <tr className="bg-[#111114] border-b border-[#222228]">
              <th className="px-6 py-4 text-[0.65rem] font-mono text-[#7A7A85] uppercase tracking-wider uppercase">Aluno</th>
              <th className="px-6 py-4 text-[0.65rem] font-mono text-[#7A7A85] uppercase tracking-wider uppercase">Contato</th>
              <th className="px-6 py-4 text-[0.65rem] font-mono text-[#7A7A85] uppercase tracking-wider uppercase text-center">Objetivo</th>
              <th className="px-6 py-4 text-[0.65rem] font-mono text-[#7A7A85] uppercase tracking-wider uppercase text-center">Status</th>
              <th className="px-6 py-4 text-[0.65rem] font-mono text-[#7A7A85] uppercase tracking-wider uppercase text-center">Início</th>
              <th className="px-6 py-4 text-[0.65rem] font-mono text-[#7A7A85] uppercase tracking-wider uppercase text-right">Ações</th>
            </tr>
          </thead>
                ...
                <tr key={student.id} className="hover:bg-[#0A0A0B]/50 transition-colors group">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[0.7rem] text-[#7A7A85] flex items-center gap-1">
                          <UserCheck2 className="w-3 h-3" /> Fiel à 6 meses
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2">
                      <button title="Ver Perfil" className="p-2 bg-[#0A0A0B] border border-[#222228] rounded-lg text-[#7A7A85] hover:text-[#F5F5F0] hover:border-[#7A7A85] transition-all">
                        <FileText className="w-4 h-4" />
                      </button>
                      <button title="Ver Evolução" className="p-2 bg-[#0A0A0B] border border-[#222228] rounded-lg text-[#7A7A85] hover:text-[#00E676] hover:border-[#00E676] transition-all">
                        <TrendingUp className="w-4 h-4" />
                      </button>
                      <button title="Mais Opções" className="p-2 bg-[#0A0A0B] border border-[#222228] rounded-lg text-[#7A7A85] hover:text-white transition-all">
